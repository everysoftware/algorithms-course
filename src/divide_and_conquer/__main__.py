...
def test_sorting():
    ...
    for i, test in enumerate(tests):
        ...
        print(
            "Sorted array (by merge sort)       :", *merge_sort(test, 0, len(test) - 1)
        )
        print("Sorted array (by iter merge sort)  :", *iterative_merge_sort(test))
        print(
            "Sorted array (by quick sort)       :",
            *quick_sort(test.copy(), 0, len(test) - 1),
        )
        print(
            "Sorted array (by quick sort3)      :",
            *quick_sort3(test.copy(), 0, len(test) - 1),
        )
        ...
        print(
            "Random select (all indices)        :",
            *[
                random_select(test.copy(), 0, len(test) - 1, j)
