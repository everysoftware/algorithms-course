...
Формат вывода
Выведите наибольшую возрастающую подпоследовательность во входном массиве в том же порядке, в котором она
...
def lis(a: list[int]) -> list[int]:
    ...
    for i, x in enumerate(a):
        ...
        # Если текущий элемент меньше или равен последнему элементу НВП, то он может её улучшить
            ...
            # Например, a = [0, 1, 1, 6, 2]. Когда мы встречаем 1, то 1 должен заменить 7, чтобы НВП была
