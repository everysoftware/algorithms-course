...
найти количество непрерывных периодов времени, когда сумма ваших транзакций равна нулю. Это может означать, что вы
вернулись к своему первоначальному балансу после серии покупок и продаж.
...
Формат вывода: Выведите одно число - количество периодов, когда сумма ваших транзакций равна нулю.
